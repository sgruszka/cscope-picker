...
local cscope_export = apply_checks(cscope)
...
return require("telescope").register_extension {
  ...
  exports = {
    references = cscope_export.references,
    definitions = cscope_export.definitions,
    called_by_this_function = cscope_export.called_by_this_function,
    calling_this_function = cscope_export.calling_this_function,
  },
}
